...
export const CAFE_SUFFIXES = ['Coffee', 'Coffee House', 'Roasters', 'Café', 'Espresso Bar'] as const;
export const RESTAURANT_SUFFIXES = ['Kitchen', 'Table', 'Cantina', 'Grill', 'Dining Room', 'Taverna'] as const;
export const STUDIO_SUFFIXES = ['Studio', 'Workshop', 'Clay Works', 'Atelier', 'Makery'] as const;
export const VENUE_SUFFIXES = ['Hall', 'Commons', 'Community Center', 'Room', 'Loft'] as const;

export const EVENT_TITLE_TEMPLATES: Record<string, string[]> = {
  'interest:basketball': [
